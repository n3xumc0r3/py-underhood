...
- **Поиск по全文у** — с подсветкой и подсказками, работает по 17 000+ строк. Разделитель токенов — любой не-буквенный символ, чтобы слова с прилипшей пунктуацией (`операторы,` и `операторы`) находились одинаково.
