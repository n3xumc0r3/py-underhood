...
- `ctrace` (по умолчанию на 3.12) — C-трассировщик `CTracer`, собственной механикой повторяющий `sys.settrace` (13.8), но целиком в C: события line/call/return снимаются с минимальной питоновской обвязки;
