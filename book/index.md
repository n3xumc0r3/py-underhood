...
~18 000 строк, ~870 КБ исходника. 12 глав и 4 приложения, 161 раздел с собственным якорем `#N.M`. Все примеры проверены на CPython 3.12+. Книга в активной доработке — возможны опечатки и неточности, если нашли — открывайте issue или PR.
